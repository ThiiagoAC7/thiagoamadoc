...
function sectionProjects(element: HTMLDivElement) {
    ...
    const projects = [

        {
            ...
            "subtitle": "A research paper that analyzes communities formed in YouTube comment sections of content creators targeting children and teenagers, using data from 10 Brazilian YouTubers. The study employs co-commenter network analysis, community detection algorithms, topic modeling, and sentiment analysis to understand user interactions and community dynamics.",
            "technologies": "Python, NetworkX, Pandas, Scikit-Learn, Matplotlib, BERTopic, NLTK, Sentiment Analysis",
